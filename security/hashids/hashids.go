...
const (
	...
	DefaultAlphabetLowerCase string = "abcdefghijklmnopqrstuvwxyz1234567890"
...
func NewDataWithLowerCase() *HashIDData {
	return &HashIDData{Alphabet: DefaultAlphabetLowerCase}
}
